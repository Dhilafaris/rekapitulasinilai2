            ...
            <div class="container mt-3">
                <table class="table text-center table-hover table-striped" style="font-size: 15px;">
                    ...
                    <tbody>
                        ...
                        $i = 1;
                        while ($db_uts_5033 = mysqli_fetch_array($query)) {
                            $total_nilai =
                                ($db_uts_5033['diskusi'] * 0.14) +
                                ($db_uts_5033['praktikum'] * 0.26) +
                                ($db_uts_5033['responsi'] * 0.15) +
                                ($db_uts_5033['uts'] * 0.20) +
                                ($db_uts_5033['uas'] * 0.25);

                            echo "<tr>";
                            echo "<td>$i</td>";
                            echo "<td>" . $db_uts_5033["username"] . "</td>";
                            echo "<td>" . $db_uts_5033["diskusi"] . "</td>";
                            echo "<td>" . $db_uts_5033["praktikum"] . "</td>";
                            echo "<td>" . $db_uts_5033["responsi"] . "</td>";
                            echo "<td>" . $db_uts_5033["uts"] . "</td>";
                            echo "<td>" . $db_uts_5033["uas"] . "</td>";
                            echo "<td>" . number_format($total_nilai, 2) . "</td>";
                            echo "<td><a href=./update.php?username=$db_uts_5033[username] >Edit</a>";
                            echo "<a href=./delete.php?username=$db_uts_5033[username] ' onclick='return Hapus()' >Hapus</a></td>";
                            echo "</tr>";
                            $i++;
                        }
                        ?>
